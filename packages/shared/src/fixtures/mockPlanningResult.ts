...
export const mockPlanningResult = {
  project: {
    ...
    title: "플랜노트",
    description:
      "사용자 목표를 공통 계획 계약에 맞춘 컴포넌트 그래프와 실행 로드맵으로 변환합니다.",
    status: "generated",
  ...
  requirement: {
    ...
    content:
      "사용자 요구사항을 분석해 핵심 컴포넌트, 의존성 그래프, 단계별 로드맵을 생성하는 플랫폼을 구축합니다.",
    source: "user",
    priority: "high",
    createdAt: generatedAt,
    updatedAt: generatedAt,
  ...
  nodes: [
    {
      ...
      type: "ui",
      label: "요구사항 입력",
      description: "사용자의 목표, 맥락, 제약사항을 계획 요청으로 수집합니다.",
      category: "프론트엔드",
      priority: "high",
      position: { x: 0, y: 80 },
      metadata: {
    ...
    },
    {
      ...
      label: "계획 API",
      description:
        "계획 요청을 검증하고 목업 또는 AI 생성 결과 반환을 조율합니다.",
      category: "백엔드",
      priority: "high",
      position: { x: 390, y: 80 },
      metadata: {
    ...
    },
    {
      ...
      label: "AI 계획 워크플로",
      description:
        "요구사항을 분석해 컴포넌트 후보, 의존성, 로드맵 단계를 생성합니다.",
      category: "AI 계층",
      priority: "high",
      position: { x: 780, y: 80 },
      metadata: {
    ...
    },
    {
      ...
      type: "ui",
      label: "그래프 캔버스",
      description: "계획 결과의 노드와 의존성을 React Flow 캔버스에 렌더링합니다.",
      category: "프론트엔드",
      priority: "high",
    ...
    },
    {
      ...
      type: "feature",
      label: "로드맵 보기",
      description: "계획 결과를 실행 순서에 맞는 구현 단계로 보여줍니다.",
      category: "계획",
      priority: "medium",
    ...
    },
    {
      ...
      label: "프로젝트 저장소",
      description:
        "프로젝트, 요구사항, 생성된 그래프, 로드맵 이력을 저장합니다.",
      category: "영속성",
      priority: "medium",
  ...
  roadmap: [
    {
      ...
      title: "공유 계획 계약 정의",
      description:
        "PlanningResult 구조와 런타임 검증 기준을 공통 TypeScript 모델로 고정합니다.",
      order: 1,
      priority: "high",
    ...
    },
    {
      ...
      title: "캔버스 MVP 구축",
      description:
        "노드 상세와 로드맵 패널을 포함한 React Flow 캔버스에 canonical mock 결과를 렌더링합니다.",
      order: 2,
      priority: "high",
    ...
    },
    {
      ...
      title: "FastAPI 골격 생성",
      description:
        "상태 확인과 목업 계획 엔드포인트를 만들고 공유 계획 결과 형태를 반환합니다.",
      order: 3,
      priority: "high",
      estimatedEffort: "medium",
    ...
    },
    {
      ...
      title: "Docker 런타임 추가",
      description:
        "API 골격 이후 데이터베이스 영속성 전에 Docker Compose 실행 환경을 고정합니다.",
      order: 4,
      priority: "medium",
      estimatedEffort: "small",
  ...
  summary:
    "MVP는 공유 계획 계약을 안정화한 뒤 웹 캔버스, FastAPI, Docker, AI 생성, 영속성을 순서대로 연결합니다.",
  metadata: {
    generatedAt,
    model: "mock",
